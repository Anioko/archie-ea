"""
Data Architecture Models for ArchiMate 3.2

This module contains the canonical data architecture models, providing
comprehensive data management capabilities aligned with ArchiMate 3.2.
...
class ConceptualDataModel(db.Model):
    ...
    created_by = db.relationship("User", backref="created_conceptual_models")
