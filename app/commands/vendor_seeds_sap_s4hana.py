...
def seed_sap_s4hana(link_capabilities: bool = True):
    ...
    with app.app_context():
        try:
            ...
            print(
                "   - Motivation Layer: ✅ Complete (10 stakeholders, 10 drivers, 9 goals, 8 outcomes, 10 principles, 12 requirements, 9 constraints, 5 assessments)"
            )
            print(
                "   - Implementation Layer: ✅ Complete (9 events, 10 work packages, 9 deliverables, 5 plateaus)"
            )
