...
class AIImportService:
    ...
    def analyze_application_for_ai_mapping(self, application_id: int) -> AIImportResult:
        ...
        try:
            ...
            result.warnings.append("AI analysis failed. Please try again later.")
...
"""
        ...
        try:
            ...
            if analysis_result["success"] and analysis_result["overall_confidence"] >= 0.7:
                try:
                    ...
                    analysis_result["mapping_created"] = False
                    analysis_result["mapping_error"] = "Vendor mapping failed. Please check data format."
            ...
            return {
                "success": False,
                "error": "Vendor analysis failed. Please try again later.",
                ...
                "rationale": ["Analysis error: Please try again later."],
                "alternative_matches": [],
    ...
    def bulk_ai_analyze_batch(
        ...
        try:
            ...
            return {"success": False, "error": "Bulk analysis creation failed. Please try again later."}
    ...
    def get_bulk_analysis_status(self, job_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": "Failed to get analysis status. Please try again later."}
    ...
    def cancel_bulk_analysis(self, job_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": "Failed to cancel analysis. Please try again later."}
    ...
    def get_bulk_analysis_results(self, job_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": "Failed to get analysis results. Please try again later."}
        ...
        for app_data in applications_data:
            try:
                ...
                try:
                    ...
                    app_result["warnings"].append("AI analysis failed. Please try again later.")
                ...
                results["applications"].append(
                    {
                        "application_name": app_data.get("name", "Unknown"),
                        "error": "Application processing failed. Please check data format.",
                        "warnings": ["Processing failed. Please check data format."],
                        "file_data": True,
                    }
                )
...
"""
    ...
    def _generate_archimate_with_ai_from_file(
        ...
        # Adapt dict data to the object interface expected by _generate_archimate_with_ai
        ...
        app_adapter = AppDataAdapter(app_data)
        return self._generate_archimate_with_ai(app_adapter, context)
                    ...
                    results["applications"].append(
                        {
                            "application_id": app.id,
                            "application_name": app.name,
                            "error": "Application analysis failed. Please try again later.",
                            "warnings": ["Analysis failed. Please try again later."],
                        }
                    )
...
"""
            ...
            return {
                ...
                "error": "Bulk analysis failed. Please try again later.",
                "critical_error": True,
            }
    ...
    def create_ai_mappings(
        ...
        try:
            ...
            db.session.rollback()
            results["errors"].append("Database operation failed. Please try again.")
    ...
    def _validate_capability_taxonomy_with_ai(self, app, app_context=None):
        ...
        try:
            ...
            return {
                "is_valid": False,
                "validation_score": 0.0,
                "issues_found": ["Validation failed. Please check data format."],
