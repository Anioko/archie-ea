...
class SeedManagementService:
    ...
    def seed_all(self):
        ...
        try:
            from app.modules.admin.v2.services.unified_seed_orchestrator_v2 import (
                UnifiedSeedOrchestrator,
            )
    ...
    def _seed_feature_flags(self):
        ...
        for flag_data in flag_defs:
            existing = db.session.execute(  # tenant-exempt: seed command
                text("SELECT 1 FROM feature_flags WHERE key = :key"),  # tenant-exempt
                {"key": flag_data["key"]},
            ).scalar()
            if existing:
                skipped += 1
    ...
    def _seed_apqc_processes(self):
        """Seed APQC processes."""
        from app.modules.vendors.services.seed_apqc_vendor_mapping import APQCVendorSeedingService
    ...
    def _seed_manufacturing_domains(self):
        ...
        from app.modules.admin.v2.services.manufacturing_domain_hierarchy_seeder_v2 import (
            ManufacturingDomainHierarchySeeder,
        )
    ...
    def _seed_capability_vendor_mappings(self):
        ...
        from app.modules.vendors.services.vendor_json_domain_importer import VendorJsonDomainImporter
        ...
        from app.modules.vendors.services.capability_vendor_app_mapping_seeder import (
    ...
    def _seed_ai_prompt_templates(self):
        ...
        from app.modules.ai_chat.services.ai_prompt_seeder import seed_default_ai_prompt_templates
    ...
    def _seed_business_domains(self):
        ...
        for domain_data in domain_defs:
            existing = db.session.execute(  # tenant-exempt: seed command
                text("SELECT 1 FROM business_domains WHERE code = :code"),  # tenant-exempt
