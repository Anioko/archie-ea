"""
Manufacturing Domain Hierarchy Seeding Service (admin v2 local)
...
class ManufacturingDomainHierarchySeeder:
    ...
    def _create_or_update_domain(self, domain_data: Dict, parent_id=None) -> ManufacturingDomainHierarchy:
