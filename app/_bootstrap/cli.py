...
def init_cli(app):
    ...
    try:
        ...
        app.logger.info("Review queue organisation backfill CLI command registered")
    except Exception as e:
        app.logger.warning(f"Failed to register review queue organisation backfill CLI: {e}")
