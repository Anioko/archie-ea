...
(function (window, document) {
     ...
     * be established or the server reported an error, which the caller also
     * treats as "fall back".
     *
     * handlers:
     ...
     *   onDone({text, domain, sources})  called once, after the stream closes,
     *                            only when there is text to render.
     */
