...
class RiskAssessmentService:
    ...
    def _analyze_capability_risks(
        ...
        # Get application coverage — try unified mappings first, fall back
        # to standard ApplicationCapabilityMapping for BusinessCapability IDs
    ...
    def _calculate_compliance_risk(self, capability: BusinessCapability, app_mappings: List) -> int:
        ...
        # Check for compliance requirements (relationship on BusinessCapability)
        if capability.compliance_requirements:
            compliance_risk += 10
